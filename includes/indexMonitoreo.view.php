 ...
 <style type="text/css">
    ...
    .efecto
    {
      ...
      color: #000;
        ...
        <div id="page-wrapper" class="loading efecto">
            <div class="row">
                <div class="col-lg-12">
                    <br>
                    <a href="<?php echo $url?>indexMain.php" title="Regresar" class="btn btn-primary btn-md" title="Expandir"> <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> </a>
                    <div class="pull-right" > <i class="fa fa-clock-o fa-lg" aria-hidden="true" > </i> Esta página se actualizará en: &nbsp;<span id="expire" class="pull-right badge" style="background: #d9534f; "></span> </div><!-- -- reloj -- -->
            ...
            <div class="row">
                <?php
                    if($actualizado == "@")
                    {
                        echo "<div class='alert alert-success' role='alert' id='mensaje'>
            	...
            	<div class="col-lg-12 col-lg-12 bs-callout bs-callout-success" style="margin: 0px 0; ">
                    

                    <section class="variable slider" style="margin-top: 0px;">
                        <div class="cargando">
                            <h3 class="pull-right" >OT retrasada(s) <span class="label label-danger indicaRetraso"></span></h3>
                            <div id="general" class="col-sm-12"></div> 
                            <div id="MPgeneral" class="col-sm-6"></div> 
                            <div id="MCgeneral" class="col-sm-6"></div>
                        </div>
                        <!--div >
                            <div id="porLider" style="width: 90%;"></div>
                        ...
                        <div >
                            ...
                            <?php
                                ...
                                {
                                  if( ($lider == $orden["responsable"]) && (date("Y-m-d", strtotime($orden["fecha_inicio_programada"])) == $diaHoy) )
                                  {
                                    ...
                                    elseif ($orden["tipo"] == "Correctivo de emergencia" || $orden["tipo"] == "Correctivo planeado")
                                    {
                                      if($orden["estado"] == "Terminado")
                                      {
                                        $totalTerminadosMC ++;
                                ...
                                /*echo "<div class='bs-example' data-example-id='navbar-link' );'> 
                                        <nav class='navbar navbar-default'> 
                                          <div class='container-fluid'> 
                                            <div class='navbar-header'> 
                                              ...
                                              <a href='#' class='navbar-brand' style='font-size:36px;'>
                                                <span class='glyphicon glyphicon-user' aria-hidden='true'></span>
                                              </a> 
                                            </div> 
                                            <div class='collapse navbar-collapse' id='bs-example-navbar-collapse-5'>
                                              <p class='navbar-text navbar-left'><h2>".$nombreLider."</h2> </p> 
                                              <p class='navbar-text navbar-left' style='font-size:80px !important;'>".$realizadoPorcentaje." % 
                                                
                                              

                                                <div class='btn-group navbar-right col-sm-6' >

                                                  <div class='panel panel-primary'> 
                                                    <div class='panel-heading'> 
                                                      <h3 class='panel-title'>Mantenimientos programados</h3> 
                                                    </div> 
                                                    <div class='panel-body'> <h2>".$totalMantenimientos." </h2></div> 
                                                  </div>

                                                  <div class='panel panel-success'> 
                                                    <div class='panel-heading'> 
                                                      <h3 class='panel-title'>Mantenimiento preventivos</h3> 
                                                    </div> 
                                                  ...
                                                  <div class='panel panel-warning'> 
                                                    <div class='panel-heading'> 
                                                      <h3 class='panel-title'>Mantenimientos correctivos</h3> 
                                                    </div> 
                                                    <div class='panel-body'>
                                                      <div class='col-sm-4'>
                                  ...
                                  echo "<div class='col-md-5'>
                                          ...
                                          <div class='card hovercard'>
                                              ...
                                              <div class='avatar'>
                                                  <img class='centrar' src='".$url."/dist/img/avatar.jpg'>
                                              </div>
                                              <div class='info'>
                                                  <div class='title'>
                                                      <a >".$nombreLider."</a>
                        ...
                        <?php
                            ...
                            // LAS ORDENES ACTUALES
                              ...
                              echo "<div>";
                                echo "<h3 style='text-align:center;' style='margin-top: 0px;' >".$nombreDiaHoy."</h3>";
                                 echo "<div id='top'>";
                                    echo "<table class='table table-bordered table-condensed table-stripped' style='font-size: 11px;'> ";
                              ...
                              foreach ($ordenes as $orden) 
                              {
                                ...
                                //echo $diaProgramado."<br>";
                                if( ($orden["responsable"] == $lider) && ($diaProgramado == $nombreDiaHoy)   )
                                {
                                  //echo $orden["fecha_inicio_programada"]."entro<br>";
                                               /*$nombreResponsable = "";
                                                ...
                                                elseif ($orden["responsable"] == 14993) 
                                                {
                                                  $nombreResponsable = "MIGUEL ANGEL TADEO MARTINEZ";
                                                }
                                                elseif ($orden["responsable"] == 15113) 
                                                {
                                                  $nombreResponsable = "JOSE ANTONIO VIRGEN RAMIREZ";
                                                }*/
                                                ...
                                                echo "<tr  >";
                                                  ...
                                                  echo "<td>".$orden["horasEstimadas"]."</td>";
                                                  ...
                                                  {
                                                    echo "<td>".date("d-m-Y",strtotime($orden["fecha_finalizacion"]))."</td>"; 
                                                  }
                            ...
                            // LAS ORDENES ATRASADAS
                              ...
                              foreach ($ordenes as $orden) 
                              {
                                ...
                                $diaProgramado = $dias[date('w', strtotime($fechaAbuscar))];
                                //echo $diaProgramado;
                                if( ($orden["responsable"] == $lider) && ($diaProgramado != $nombreDiaHoy) && (date("Y-m-d", strtotime($orden["fecha_inicio_programada"])) >= $fecha_inicio && date("Y-m-d", strtotime($orden["fecha_inicio_programada"])) <= $diaHoy)  && $orden["estado"] != "Terminado")
                                {
                                                /*$nombreResponsable = "";
                                                if($orden["responsable"] == 41185)
                                                {
                ...
                <div class="col-lg-12 bs-callout bs-callout-info" >
                    <form action="load.php" method="POST" enctype="multipart/form-data">
                       <div class='form-group'>
                            <label class='col-sm-2 control-label' >Archivo de carga</label>
                            <div class='col-sm-10'>  
                                <input type='file' id='archivo' name='archivo' onChange='extensionCHK(this);' required>
                                <font size='1' color='gray'>(Archivos soportados: monitoreo.XLSX)</font>
                        ...
                        <div class="form-group">
                            <label class='col-sm-2 control-label' ></label>
                            <div class='col-sm-10'> 
                                <button type="submit" class="btn btn-success"> <span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Cargar documento</button>
                            </div>     
                        </div>
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                $(".imagenPrincipal").css("display", "100%");
                $(".centrar").css("display", "initial")
