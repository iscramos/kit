                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Equipo</th>
                                            <th>Familia</th>
                                            <th>Tiempo base de operación</th>
                                            <th>Acción</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            ...
                                            {
                                                echo "<tr campoid={$activo->id}>";
                                                    echo "<th width='5px' class='spec'>$i</th>";
                                                    echo "<td>".$activo->nombre_equipo."</td>";
                                                    echo "<td>".$activo->familia."</td>";
                                                    echo "<td>".$activo->tiempoBaseOperacion."</td>";
                                                     echo "<td>";
		    ...
		    <div class="modal-dialog" role="document">
    		    <div class="modal-content">
    		      ...
    		      <div class="modal-body">
                    <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createActivo_equipo.php">
     ...
     $('[data-toggle="confirmation"]').confirmation(
              {
                ...
                onConfirm: function(event) {
                  ...
                  window.location.href='deleteActivo_equipo.php?id='+idR;
                  }
        ...
        $(document).ready(function() 
        {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateActivo_equipo.php?id="+uID, true);
