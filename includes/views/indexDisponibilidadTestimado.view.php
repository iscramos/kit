            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Tiempo estimado para disponibilidad...</h3>
                    </div>
                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            $i=1;
                                            foreach ($disponibilidad_tiempos as $disponibilidad_te):
                                            {
                                                echo "<tr campoid='".$disponibilidad_te->id."'>";
                                                    echo "<th width='5px' class='spec'>$i</th>";
                                                    echo "<td>".$disponibilidad_te->organizacion."</td>";
                                                    echo "<td>".$disponibilidad_te->programacion."</td>";
                                                    echo "<td>".$disponibilidad_te->descripcion."</td>";
                                                    echo "<td>".$disponibilidad_te->te."</td>";
