                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            //$i=1;
                                            foreach ($recursos_actividades as $actividad):
                                            {
                                                echo "<tr campoid='".$actividad->id."'>";
                                                    //echo "<th width='5px' class='spec'>$i</th>";
                                                    //echo "<td>".$actividad->id_actividad."</td>";
                                                    echo "<td>".$actividad->nombre."</td>";
                                                    echo "<td>".$actividad->etapa."</td>";
                                                    echo "<td>".$actividad->objetivo."</td>";
                                                    echo "<td>".$actividad->eficiencia_exponencial."</td>";
                                                    echo "<td>".$actividad->pago_surco."</td>";
                                                    echo "<td>".$actividad->tipo_jornal."</td>";
                                                    echo "<td>".$actividad->tipo_pago."</td>";
                                                    echo "<td>".$actividad->centro_costo."</td>";
                                                    echo "<td>".$actividad->factor."</td>";


                                                    echo "<td>";
                                                            echo "<a type='button' class='btn btn-warning btn-sm optionEdit' valueEdit='".$actividad->id."' title='Editar registro' ><i class='fa fa-pencil-square-o'></i></a>";
          ...
          <div class="modal-dialog " role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Agregar / Modificar Actividad</h4>
              </div>
              <div class="modal-body">
                <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createRecursoActividad.php">
         ...
         <script type="text/javascript">
            ...
            $('[data-toggle="confirmation"]').confirmation(
            {
                ...
                onConfirm: function(event) {
                  ...
                  window.location.href='deleteRecursoActividad.php?id='+id;
                },
            });
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateRecursoActividad.php?id="+uID, true);
