                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            $i=1;
                                            foreach ($mpideales as $ideal):
                                            {
                                                echo "<tr campoid={$ideal->id}>";
                                                    echo "<th width='5px' class='spec'>$i</th>";
                                                    echo "<td>".$ideal->nombre_equipo."</td>";
                                                    echo "<td>".$ideal->familia."</td>";
                                                    echo "<td>".$ideal->A."</td>";
                                                    echo "<td>".$ideal->B."</td>";
                                                    echo "<td>".$ideal->C."</td>";
                                                    echo "<td>".$ideal->D."</td>";
                                                    ...
                                                    echo "<td>";
                                                        echo "<a type='button' class='btn btn-warning btn-circle btn-sm optionEdit' valueEdit='".$ideal->id."' title='Editar registro' ><i class='fa fa-pencil-square-o'></i></a>";
