            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Días para disponibilidad...</h3>
                    </div>
                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            //$i=1;
                                            foreach ($disponibilidad_calendarios as $disponibilidad_calendario):
                                            {
                                                echo "<tr campoid='".$disponibilidad_calendario->id."'>";
                                                    /*echo "<th width='5px' class='spec'>$i</th>";*/
                                                    echo "<td>".$disponibilidad_calendario->ano."</td>";
                                                    echo "<td>".$disponibilidad_calendario->mes."</td>";
                                                    echo "<td>".$disponibilidad_calendario->semana."</td>";
                                                    echo "<td>".date("d-m-Y", strtotime($disponibilidad_calendario->dia))."</td>";
                                                echo "</tr>";
