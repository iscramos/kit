                                        ...
                                        foreach ($zancos_problemas as $p):
                                        {
                                            ...
                                            echo "<tr campoid='".$p->id."'>";
                                                ...
                                                echo "<td>";
                                                    ...
                                                    echo " <a type='button' class='btn btn-warning btn-sm optionEdit' valueEdit='".$p->id."' title='Editar registro' >Editar</a>";
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">Agregar / Modificar problema</h4>
		      </div>
		      <div class="modal-body">
                <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createZancos_problemas.php">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateZancos_problemas.php?id="+uID, true);
