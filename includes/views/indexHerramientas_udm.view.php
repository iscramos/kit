                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <tbody>
                                    <?php
                                        $i=1;
                                        foreach ($herramientas_udm as $u):
                                        {
                                           
                                            echo "<tr campoid='".$u->id."'>";
                                                echo "<th width='5px' class='spec'>$i</th>";
                                                echo "<td>".$u->udm."</td>";
                                                echo "<td>".$u->descripcion."</td>";
                                                echo "<td>";

                                                    echo " <a type='button' class='btn btn-warning btn-sm optionEdit' valueEdit='".$u->id."' title='Editar registro' >Editar</a>";
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
                <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createHerramientas_udm.php">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateHerramientas_udm.php?id="+uID, true);
