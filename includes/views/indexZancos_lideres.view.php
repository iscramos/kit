                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach ($zancos_lideres as $lider):
                                        {
                                            ...
                                            echo "<tr campoid='".$lider->id."'>";
                                                echo "<th width='5px' class='spec'>$i</th>";
                                                echo "<td>".$lider->ns."</td>";
                                                echo "<td>".$lider->nombre."</td>";

                                                /*echo "<td>";

                                                    echo " <a type='button' class='btn btn-warning btn-sm optionEdit' valueEdit='".$t->id."' title='Editar registro' >Editar</a>";*/
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">Agregar / Modificar líder</h4>
		      </div>
		      <div class="modal-body">
                <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createZancos_lideres.php">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateZancos_lideres.php?id="+uID, true);
