            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Tiempo operacional para disponibilidad...</h3>
                    </div>
                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            $i=1;
                                            foreach ($disponibilidad_toperacional as $disponibilidad_to):
                                            {
                                                $mttr = 0;
                                                $mtbf = 0;

                                                $mttr = ($disponibilidad_to->tiempo_operacional) * 2 ;
                                                $mtbf = ($disponibilidad_to->tiempo_operacional) * 7 ;
                                                echo "<tr campoid='".$disponibilidad_to->id."'>";
                                                    echo "<th width='5px' class='spec'>$i</th>";
                                                    echo "<td>".$disponibilidad_to->planta."</td>";
                                                    echo "<td>".$disponibilidad_to->familia."</td>";
                                                    echo "<td>".$disponibilidad_to->tiempo_operacional."</td>";
                                                    echo "<td>".$mttr."</td>";
                                                    echo "<td>".$mtbf."</td>";
                                                echo "</tr>";
