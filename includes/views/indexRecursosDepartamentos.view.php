                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            $i=1;
                                            foreach ($recursos_departamentos as $departamento):
                                            {
                                                echo "<tr campoid='".$departamento->id."'>";
                                                    echo "<th width='5px' class='spec'>$i</th>";
                                                    echo "<td>".$departamento->departamento."</td>";


                                                    echo "<td>";
                                                            echo "<a type='button' class='btn btn-warning btn-sm optionEdit' valueEdit='".$departamento->id."' title='Editar registro' ><i class='fa fa-pencil-square-o'></i></a>";
          ...
          <div class="modal-dialog " role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Agregar / Modificar Departamento</h4>
              </div>
              <div class="modal-body">
                <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createRecursoDepartamento.php">
         ...
         <script type="text/javascript">
            ...
            $('[data-toggle="confirmation"]').confirmation(
            {
                ...
                onConfirm: function(event) {
                  ...
                  window.location.href='deleteRecursoDepartamento.php?id='+id;
                },
            });
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateRecursoDepartamento.php?id="+uID, true);
