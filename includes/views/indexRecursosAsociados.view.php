                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            //$i=1;
                                            foreach ($recursos_asociados as $asociado):
                                            {
                                                echo "<tr campoid='".$asociado->id."'>";
                                                    //echo "<th width='5px' class='spec'>$i</th>";
                                                    echo "<td>".$asociado->tipo."</td>";
                                                    echo "<td>".$asociado->rango."</td>";
                                                    echo "<td>".$asociado->codigo."</td>";
                                                    echo "<td>".$asociado->nombre."</td>";
                                                    echo "<td>".$asociado->lider."</td>";


                                                    echo "<td>";
                                                            echo "<a type='button' class='btn btn-warning btn-sm optionEdit' valueEdit='".$asociado->id."' title='Editar registro' ><i class='fa fa-pencil-square-o'></i></a>";
          ...
          <div class="modal-dialog " role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Agregar / Modificar Asociado</h4>
              </div>
              <div class="modal-body">
                <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createRecursoAsociado.php">
         ...
         <script type="text/javascript">
            ...
            $('[data-toggle="confirmation"]').confirmation(
            {
                ...
                onConfirm: function(event) {
                  ...
                  window.location.href='deleteRecursoAsociado.php?id='+id;
                },
            });
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateRecursoAsociado.php?id="+uID, true);
