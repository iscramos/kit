                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <tbody>
                                    <?php
                                        $i=1;
                                        foreach ($zancos_acciones as $acciones):
                                        {
                                           
                                            echo "<tr campoid='".$acciones->id."'>";
                                                echo "<th width='5px' class='spec'>$i</th>";
                                                echo "<td>".$acciones->accion."</td>";

                                                echo "<td>";

                                                    echo " <a type='button' class='btn btn-warning btn-sm optionEdit' valueEdit='".$acciones->id."' title='Editar registro' >Editar</a>";
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">Agregar / Modificar acción</h4>
		      </div>
		      <div class="modal-body">
                <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createZancos_acciones.php">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateZancos_acciones.php?id="+uID, true);
