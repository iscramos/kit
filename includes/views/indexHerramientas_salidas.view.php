                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <tbody>
                                    <?php
                                        $i=1;
                                        foreach ($asociadoData as $asociado):
                                        {
                                            ...
                                            echo "<tr >";
                                                ...
                                                echo "<td>";
                                                    ...
                                                    echo " <a type='button' href='indexHerramientas_temporal.php?codigo=".$asociado["codigo"]."' class='btn btn-success btn-sm' title='Despachar' >
