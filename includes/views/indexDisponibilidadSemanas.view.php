            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Semanas para disponibilidad...</h3>
                    </div>
                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            //$i=1;
                                            foreach ($disponibilidad_semanas as $disponibilidad_semana):
                                            {
                                                echo "<tr campoid='".$disponibilidad_semana->id."'>";
                                                    /*echo "<th width='5px' class='spec'>$i</th>";*/
                                                    echo "<td>".$disponibilidad_semana->semana."</td>";
                                                echo "</tr>";
