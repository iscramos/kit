            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Activos para disponibilidad...</h3>
                    </div>
                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            $i=1;
                                            foreach ($disponibilidad_activos as $disponibilidad_activo):
                                            {
                                                echo "<tr campoid='".$disponibilidad_activo->id."'>";
                                                    echo "<th width='5px' class='spec'>$i</th>";
                                                    echo "<td>".$disponibilidad_activo->organizacion."</td>";
                                                    echo "<td>".$disponibilidad_activo->activo."</td>";
                                                    echo "<td>".$disponibilidad_activo->familia."</td>";
                                                    echo "<td>".$disponibilidad_activo->descripcion."</td>";
                                                    echo "<td>".$disponibilidad_activo->criticidad."</td>";
                                                echo "</tr>";
