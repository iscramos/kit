                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            //$i=1;
                                            foreach ($recursos_bonos_apoyos as $apoyos):
                                            {
                                                echo "<tr campoid='".$apoyos->id."'>";
                                                    //echo "<th width='5px' class='spec'>$i</th>";
                                                    echo "<td>".$apoyos->id."</td>";
                                                    echo "<td>".$apoyos->codigo."</td>";
                                                    echo "<td>".$apoyos->nombre."</td>";
                                                    echo "<td>".$apoyos->nombre_actividad."</td>";
                                                    echo "<td>".date("d-m-Y", strtotime($apoyos->fecha))."</td>";
                                                    echo "<td>".$apoyos->lider."</td>";
                                                    echo "<td>".$apoyos->surcos_cajas."</td>";
                                                    echo "<td>".$apoyos->tiempo."</td>";
                                                    echo "<td>".$apoyos->gh."</td>";
                                                    echo "<td>".$apoyos->pago_por."</td>";
                                                    echo "<td>".$apoyos->subpago."</td>";


                                                    echo "<td>";
                                                            /*echo "<a type='button' class='btn btn-warning btn-sm optionEdit' valueEdit='".$apoyos->id."' title='Editar registro' ><i class='fa fa-pencil-square-o'></i></a>";*/
          ...
          <div class="modal-dialog " role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Agregar / Modificar Bono Apoyo</h4>
              </div>
              <div class="modal-body">
                <form name='frmbono' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createRecursoBonoApoyo.php">
         ...
         <script type="text/javascript">
            ...
            $('[data-toggle="confirmation"]').confirmation(
            {
                ...
                onConfirm: function(event) {
                  ...
                  window.location.href='deleteRecursoBonoApoyo.php?id='+id;
                },
            });
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateRecursoBonoApoyo.php?id="+uID, true);
