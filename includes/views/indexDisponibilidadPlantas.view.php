                            ...
                            <div class="x_content">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-hover dataTables-example dataTables_wrapper jambo_table bulk_action" >
                                    ...
                                    <tbody>
                                        <?php
                                            $i=1;
                                            foreach ($disponibilidad_plantas as $disponibilidad_planta):
                                            {
                                                echo "<tr campoid='".$disponibilidad_planta->id."'>";
                                                    echo "<th width='5px' class='spec'>$i</th>";
                                                    echo "<td>".$disponibilidad_planta->organizacion."</td>";
                                                    echo "<td>".$disponibilidad_planta->descripcion."</td>";
                                                echo "</tr>";
