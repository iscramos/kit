                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach ($zancos_tamanos as $t):
                                        {
                                            ...
                                            echo "<tr campoid='".$t->id."'>";
                                                echo "<th width='5px' class='spec'>$i</th>";
                                                echo "<td>".$t->tamano."</td>";
                                                echo "<td>".$t->limite_semana."</td>";
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">Agregar / Modificar tamaño</h4>
		      </div>
		      <div class="modal-body">
                <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createZancos_tamanos.php">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateZancos_tamanos.php?id="+uID, true);
