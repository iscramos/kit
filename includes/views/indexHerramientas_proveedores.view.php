                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <tbody>
                                    <?php
                                        $i=1;
                                        foreach ($herramientas_proveedores as $proveedor):
                                        {
                                           
                                            echo "<tr campoid='".$proveedor->id."'>";
                                                echo "<th width='5px' class='spec'>$i</th>";
                                                echo "<td>".$proveedor->descripcion."</td>";

                                                echo "<td>";

                                                    echo " <a type='button' class='btn btn-warning btn-sm optionEdit' valueEdit='".$proveedor->id."' title='Editar registro' >Editar</a>";
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">Agregar / Modificar proveedor</h4>
		      </div>
		      <div class="modal-body">
                <form name='frmtipo' class="form-horizontal" id="divdestino" method="post" action="<?php echo $url; ?>createHerramientas_proveedores.php">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                function ajaxCargaDatos(divdestino, uID)
                {
                    ...
                    ajax.open("GET", "updateHerramientas_proveedores.php?id="+uID, true);
