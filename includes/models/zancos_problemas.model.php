...
class Zancos_problemas {
	...
	public static function getAll() {
		...
		$sql = 'select * from zancos_problemas ORDER BY descripcion ASC';
	...
	public static function getAllByOrden($campo, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM zancos_problemas ORDER BY $campo $orden";
	...
	public static function getAllInnerAlmacen() 
	{
		...
		// Build database query
		$sql = "SELECT herramientas_categorias.*, zancos_problemas.descripcion as descripcion
				FROM herramientas_categorias
				INNER JOIN zancos_problemas ON herramientas_categorias.id_almacen = zancos_problemas.id";
		//die($sql);
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select * from zancos_problemas where id = ?";
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into zancos_problemas (descripcion) values (?)";
	...
	public function update() {
		...
		// Build database query
		$sql = "update zancos_problemas set descripcion = ? where id = ?";
	...
	public function delete() {
		...
		// Build database query
		$sql = "delete from zancos_problemas where id = ?";
