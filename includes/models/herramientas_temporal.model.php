...
class Herramientas_temporal {
	...
	public static function getAll() {
		...
		$sql = 'select * from herramientas_temporal';
	...
	public static function getAllByOrden($campo, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM herramientas_temporal ORDER BY $campo $orden";
	...
	public static function getAllInnerAlmacen() 
	{
		...
		// Build database query
		$sql = "SELECT herramientas_temporal.*, herramientas_almacenes.descripcion as descripcion
				FROM herramientas_temporal
				INNER JOIN herramientas_almacenes ON herramientas_temporal.id_almacen = herramientas_almacenes.id";
		//die($sql);
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select * from herramientas_temporal where id = ?";
	...
	public static function getByClave($clave) {
		...
		// Build database query
		$sql = "select * from herramientas_temporal where clave = ?";
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into herramientas_temporal (clave, cantidad, codigo_asociado) values (?, ?, ?)";
		...
		if ($statement->prepare($sql)) {
			...
			$statement->bind_param('ssi', $this->clave, $this->cantidad, $this->codigo_asociado);
	...
	public function update() {
		...
		// Build database query
		$sql = "update herramientas_temporal set stock = stock + ? where clave = ?";
	...
	public function adicionar() {
		...
		// Build database query
		$sql = "update herramientas_temporal set cantidad = cantidad + ? where codigo_asociado = ? AND clave = ?";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('sis', $this->cantidad, $this->codigo_asociado, $this->clave);
	...
	public function delete() {
		...
		// Build database query
		$sql = "delete from herramientas_temporal where clave = ? and codigo_asociado = ?";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('si', $this->clave, $this->codigo_asociado);
	...
	public function deleteAll() {
		...
		// Build database query
		$sql = "delete from herramientas_temporal where codigo_asociado = ?";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('i', $this->codigo_asociado);
