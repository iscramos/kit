...
class Description_roles {
	...
	public static function getAll() {
		...
		$sql = 'select * from description_roles order by description';
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into cat_tipos (etiqueta) values (?)";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('s', $this->etiqueta);
	...
	public function update() {
		...
		// Build database query
		$sql = "update cat_tipos set etiqueta = ? where id = ?";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('si', $this->etiqueta, $this->id);
	...
	public function delete() {
		...
		// Build database query
		$sql = "delete from cat_tipos where id = ?";
