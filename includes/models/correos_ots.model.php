...
class Correos_ots {
	...
	public static function getAllByOrden($columna, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM correos_ots ORDER BY $columna $orden";
		//echo $sql;
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select ot from correos_ots where ot = ?";
	...
	public function inserta_dura() 
	{
		...
		// Build database query
		$sql = "INSERT INTO correos_ots values $this->q";
