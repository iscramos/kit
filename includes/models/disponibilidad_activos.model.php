...
class Disponibilidad_activos {
	...
	public static function getAll() {
		...
		$sql = 'select * from disponibilidad_activos';
	...
	public static function getAllByEquipo($equipo) 
	{
		...
		$sql = "SELECT * FROM disponibilidad_activos WHERE activo = '$equipo' ";
		return self::getBySql($sql);
	}
	...
	public static function getAllByOrden($columna, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM disponibilidad_activos ORDER BY $columna $orden";
		//echo $sql;
		// Return objects
		return self::getBySql($sql);
	}
