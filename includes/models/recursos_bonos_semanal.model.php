...
class Recursos_bonos_semanal {
	...
	public static function getAll() {
		...
		$sql = 'select * from recursos_bonos_semanal';
	...
	public static function getAllByOrden($columna, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM recursos_bonos_semanal ORDER BY $columna $orden";
		//echo $sql;
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select * from recursos_bonos_semanal where id = ?";
	...
	public function update() {
		...
		// Build database query
		$sql = "update recursos_bonos_semanal set pago_especial = ?, surcos_cajas = ?, tiempo = ?, hora_inicio = ?, hora_fin = ?, gh = ?, surcos_reales = ?, surcos_hora = ?, eficiencia = ?, subpago = ?, tiempo_muerto = ?, observacion = ? where id = ?";
	...
	public function delete() {
		...
		// Build database query
		$sql = "delete from recursos_bonos_semanal where id = ?";
