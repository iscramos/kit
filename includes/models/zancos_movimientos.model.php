...
class Zancos_movimientos {
	...
	public static function getAll() {
		...
		$sql = 'select * from zancos_movimientos ORDER BY id_registro desc';
	...
	public static function getAllByOrden($campo, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM zancos_movimientos ORDER BY $campo $orden";
	...
	public static function getAllInner() 
	{
		...
		// Build database query
		$sql = "SELECT zancos_movimientos.*, zancos_tamanos.tamano as tamano_descripcion, zancos_tamanos.limite_semana as limite_semana 
	...
	public static function getAllLastInsert() {
		...
		// Build database query
		$sql = "SELECT MAX(id_registro) AS ultimo FROM zancos_movimientos";
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select * from zancos_movimientos where id = ?";
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into zancos_movimientos (no_zanco, tamano, tiempo_limite, tipo_movimiento, gh, zona, fecha_activacion_o_baja, ns_salida_lider, nombre_lider_salida, fecha_salida, wk_salida,
	...
	public function update() {
		...
		// Build database query
		$sql = "update zancos_movimientos set no_zanco = ?, tamano = ?, tiempo_limite = ?, tipo_movimiento = ?, gh = ?, zona = ?, fecha_activacion_o_baja = ?, ns_salida_lider = ?, nombre_lider_salida = ?, fecha_salida = ?, wk_salida = ?, fecha_entrega = ?, wk_entrega = ?, fecha_servicio = ?, descripcion_problema = ? where id_registro = ?";
	...
	public function delete() {
		...
		// Build database query
		$sql = "delete from zancos_movimientos where id = ?";
