...
class Disponibilidad_logs {
	...
	public static function getAll() {
		...
		$sql = 'select * from disponibilidad_logs';
	...
	public static function getAllByOrden($columna, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM disponibilidad_logs ORDER BY $columna $orden";
		//echo $sql;
		// Return objects
		return self::getBySql($sql);
	}
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into disponibilidad_logs (fecha, tabla, accion) values (?, ?, ?)";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('sss', $this->fecha, $this->tabla, $this->accion);
	...
	public function inserta_dura() 
	{
		...
		// Build database query
		$sql = "INSERT INTO disponibilidad_logs values $this->q";
	...
	public function truncate() 
	{
		...
		// Build database query
		$sql = "truncate table disponibilidad_logs";
