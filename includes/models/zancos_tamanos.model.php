...
class Zancos_tamanos {
	
	public $id;
	public $tamano;
	public $limite_semana;
	...
	public static function getAll() {
		...
		$sql = 'select * from zancos_tamanos ORDER BY tamano ASC';
	...
	public static function getAllByOrden($campo, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM zancos_tamanos ORDER BY $campo $orden";
	...
	public static function getAllInnerAlmacen() 
	{
		...
		// Build database query
		$sql = "SELECT herramientas_categorias.*, zancos_tamanos.descripcion as descripcion
				FROM herramientas_categorias
				INNER JOIN zancos_tamanos ON herramientas_categorias.id_almacen = zancos_tamanos.id";
		//die($sql);
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select * from zancos_tamanos where id = ?";
		...
		if ($statement->prepare($sql)) {
			...
			$statement->bind_result($id, $tamano, $limite_semana);
		...
		$object->limite_semana = $limite_semana;
		return $object;
	}
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into zancos_tamanos (tamano, limite_semana) values (?, ?)";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('si', $this->tamano, $this->limite_semana);
	...
	public function update() {
		...
		// Build database query
		$sql = "update zancos_tamanos set tamano = ?, limite_semana = ? where id = ?";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('sii', $this->tamano, $this->limite_semana, $this->id);
	...
	public function delete() {
		...
		// Build database query
		$sql = "delete from zancos_tamanos where id = ?";
