...
class Herramientas_entradas {
	...
	public static function getAll() {
		...
		$sql = 'select * from herramientas_entradas';
	...
	public static function getAllByOrden($campo, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM herramientas_entradas ORDER BY $campo $orden";
	...
	public static function getAllInnerAlmacen() 
	{
		...
		// Build database query
		$sql = "SELECT herramientas_entradas.*, herramientas_almacenes.descripcion as descripcion
				FROM herramientas_entradas
				INNER JOIN herramientas_almacenes ON herramientas_entradas.id_almacen = herramientas_almacenes.id";
		//die($sql);
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select * from herramientas_entradas where id = ?";
	...
	public static function getByClave($clave) {
		...
		// Build database query
		$sql = "select * from herramientas_entradas where clave = ?";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind variable to prepared statement
			$statement->bind_result($id, $clave, $fechaEntrada, $cantidad);
		...
		$object->id = $id;
		$object->clave = $clave;
		$object->fechaEntrada = $fechaEntrada;
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into herramientas_entradas (clave, fechaEntrada, cantidad) values (?, ?, ?)";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			/*echo $this->id_almacen;
			echo $this->categoria;
			echo $this->stock;*/

			$statement->bind_param('ssi', $this->clave, $this->fechaEntrada, $this->cantidad);
	...
	public function update() {
		...
		// Build database query
		$sql = "update herramientas_entradas set cantidad = ? where id = ?";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('ii', $this->cantidad, $this->id);
