...
class Disponibilidad_tiempos {
	...
	public static function getAll() {
		...
		$sql = 'select * from disponibilidad_tiempos';
	...
	public static function getAllByOrden($columna, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM disponibilidad_tiempos ORDER BY $columna $orden";
		//echo $sql;
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getByCodigo($programacion) {
	
		// Initialize result array
		$result = array();
		
		// Build database query
		$sql = "select programacion, te from disponibilidad_tiempos where programacion = ?";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('s', $programacion);
			
			// Execute statement
			$statement->execute();
			
			// Bind variable to prepared statement
			$statement->bind_result($programacion, $te);
		...
		// Build new object
		$object = new self;
		$object->programacion = $programacion;
		$object->te = $te;
		return $object;
	}
