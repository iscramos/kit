...
class Herramientas_udm {
	...
	public static function getAll() {
		...
		$sql = 'select * from herramientas_udm';
	...
	public static function getAllByOrden($campo, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM herramientas_udm ORDER BY $campo $orden";
	...
	public static function getAllInnerAlmacen() 
	{
		...
		// Build database query
		$sql = "SELECT herramientas_udm.*, herramientas_almacenes.descripcion as descripcion
				FROM herramientas_udm
				INNER JOIN herramientas_almacenes ON herramientas_udm.id_almacen = herramientas_almacenes.id";
		//die($sql);
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select * from herramientas_udm where id = ?";
		...
		if ($statement->prepare($sql)) {
			...
			$statement->bind_result($id, $udm, $descripcion);
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into herramientas_udm (udm, descripcion) values (?, ?)";
		...
		if ($statement->prepare($sql)) {
			...
			$statement->bind_param('ss', $this->udm, $this->descripcion);
	...
	public function update() {
		...
		// Build database query
		$sql = "update herramientas_udm set descripcion = ? where id = ?";
	...
	public function delete() {
		...
		// Build database query
		$sql = "delete from herramientas_udm where id = ?";
