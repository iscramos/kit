...
class Recursos_departamentos {
	...
	public static function getAll() {
		...
		$sql = 'select * from recursos_departamentos';
	...
	public static function getAllByOrden($columna, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM recursos_departamentos ORDER BY $columna $orden";
		//echo $sql;
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select * from recursos_departamentos where id = ?";
		...
		if ($statement->prepare($sql)) {
			...
			$statement->bind_result($id, $departamento);
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into recursos_departamentos (departamento) values (?)";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('s', $this->departamento);
	...
	public function update() {
		...
		// Build database query
		$sql = "update recursos_departamentos set departamento = ? where id = ?";
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('si', $this->departamento, $this->id);
	...
	public function delete() {
		...
		// Build database query
		$sql = "delete from recursos_departamentos where id = ?";
