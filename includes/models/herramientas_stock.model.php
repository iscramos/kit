...
class Herramientas_stock {
	...
	public static function getAll() {
		...
		$sql = 'select * from herramientas_stock';
	...
	public static function getAllByOrden($campo, $orden) {
		...
		// Build database query
		$sql = "SELECT * FROM herramientas_stock ORDER BY $campo $orden";
	...
	public static function getAllInnerAlmacen() 
	{
		...
		// Build database query
		$sql = "SELECT herramientas_stock.*, herramientas_almacenes.descripcion as descripcion
				FROM herramientas_stock
				INNER JOIN herramientas_almacenes ON herramientas_stock.id_almacen = herramientas_almacenes.id";
		//die($sql);
		// Return objects
		return self::getBySql($sql);
	}
	...
	public static function getById($id) {
		...
		// Build database query
		$sql = "select * from herramientas_stock where id = ?";
	...
	public static function getByClave($clave) {
		...
		// Build database query
		$sql = "select * from herramientas_stock where clave = ?";
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into herramientas_stock (clave, stock) values (?, ?)";
		...
		if ($statement->prepare($sql)) {
			...
			$statement->bind_param('si', $this->clave, $this->stock);
	...
	public function update() {
		...
		// Build database query
		$sql = "update herramientas_stock set stock = stock + ? where clave = ?";
