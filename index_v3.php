...
<body >
        ...
        <div class="middle">
            <!--div class="row-fluid"-->
                ...
                <div class="col-md-4 col-md-4 col-md-4-offset inner">
                    ...
                    <hr>
                	<h4 class="text-center">Kit de mantenimiento v3</h4>
                    ...
                    <form role="form" action="" method="post" class="text-center">
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control input-md" placeholder="Usuario" name="email" type="text" autocomplete="off" required value="" autofocus>
                            </div>
                            <div class="form-group">
                                <input class="form-control input-md" placeholder="Password" name="password" type="password" autocomplete="off" required value="">
                            </div>
    ...
    <div id="pie"> 
        ...
        <span >© 2018 NatureSweet | Planta Colima</span>
    </div>
