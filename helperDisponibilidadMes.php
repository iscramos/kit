...
{   
    ...
    if($parametro == "DISPONIBILIDADMES") // PARA LA DISPONIBILIDAD GENERAL DE TODO EL AÑO
    {   
            ...
            $str.="<div class='row text-center'>";
                $str.="<div class='col-md-12 col-md-12'>
                            <button class='btn btn-default btn-success btn-sm mesMuestra' valor='".$nombreMes."'>".$nombreMes."</button>
                        </div>";
                $str.="</div><hr style='border-top: 1px dashed #8c8b8b;'>";
        ...
        $str.="<table class='table table-condensed table-bordered table-hover hidden dataTables-example dataTables_wrapper jambo_table bulk_action todos$nombreMes' id='original' > ";
        ...
        $str.="<table class='table table-bordered table-condensed dataTables-example dataTables_wrapper jambo_table bulk_action familia$nombreMes mesShow hidden' id='disponibilityForFamily' style='font-size: 10px;'>";
            $str.="<thead class='bg-primary'>
                    <tr >
                    ...
                    <tbody>";
                        ...
                        foreach ($familias as $familia) 
                        {
                            ...
                            // ===============================================================
                                ...
                                $str.="<td>
                                    <button title='Ver equipos de la familia' class='detalles_familia$nombreMes ".$familia->familia." btn btn-info btn-sm btn-circle' parametroDetalle='".$familia->familia."'
                                        parametroAno='".$ano."'
                                        parametroMes='".$mes."'
                                        >
                                        <i class='fa fa-eye' aria-hidden='true' ></i> 
            ...
            $str.="<button class='regresarFamilia$nombreMes btn btn-success hidden btn-circle btn-sm' title='Ver familias'>
            ...
            $str.="<button class='regresarEquipo$nombreMes btn btn-warning hidden btn-circle btn-sm' title='Ver área'>
                        <i class='fa fa-chevron-circle-up' aria-hidden='true' ></i>
                    </button>
...
$.each(meses, function(key2, value2)
{
    ...
    $.each(familias, function( key, value ) 
    {
        ...
        else
        {
            ...
            $(".familia"+mes+" ."+familia+"_real_A_familia button").removeClass("btn-warning");
        ...
        else
        {
            ...
            $(".familia"+mes+" ."+familia+"_real_B_familia button").removeClass("btn-warning");
        ...
        else
        {
            ...
            $(".familia"+mes+" ."+familia+"_real_C_familia button").removeClass("btn-warning");
        ...
        else
        {
            ...
            $(".familia"+mes+" ."+familia+"_real_D_familia button").removeClass("btn-danger");
        ...
        else
        {
            ...
            $(".familia"+mes+" ."+familia+"_real_E_familia button").removeClass("btn-warning");
